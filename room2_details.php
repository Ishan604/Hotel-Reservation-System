...
<body>
  ...
  <section class="apartment-overview container">
    ...
    <div class="photo-gallery">
      <h2>Princely House Apartment</h2>
      <h6 style="color: blue;">42, Humes Road, 80000 Galle, Sri Lanka.</h6>
    ...
    <div class="about-property">
      ...
      <p>Princely House Apartment is located in the heart of Galle, providing easy access to local attractions and the beach. This apartment is designed for comfort, featuring modern amenities to ensure a pleasant stay.</p>
      <p>Enjoy a spacious living area, a fully equipped kitchen, and comfortable bedrooms. Ideal for both short-term and long-term stays, this apartment provides a peaceful retreat with all the essentials for a relaxing experience.</p>
    </div>
  ...
  <form method="post" action="">
    <table class="room-info-table">
        ...
        <tr>
          ...
          <td>
            <input type="hidden" name="roomno" value="Room 01(villa pear breez)">
            Room 01
          </td>
        </tr>
        <tr>
  ...
  <form method="post" action="">
    <table class="room-info-table">
        ...
        <tr>
          <td><strong>Room Number</strong></td>
          <td>
            <input type="hidden" name="roomno" value="Room 02(villa pear breez)">
            Room 02
          </td>
        </tr>
        <tr>
  ...
  <form method="post" action="">
    <table class="room-info-table">
        ...
        <tr>
          <td><strong>Room Type</strong></td>
          <td>
            <input type="hidden" name="roomtype" value="Room 03(villa pear breez)">
            2 Large Beds
          </td>
        </tr>
        <tr>
